                    ...
                    <Switch>
                        <Route exact path="/" component={MainPage}>
                            ...
                            <div>
                                ...
                                <br></br>
                                <label style={{ margin: '5px' }} htmlFor="full">
                                    Enter a Full URL:
                                </label>
                                <input
                            ...
                            <div>
                                <p>
                                    If you want to edit or delete a URL, please
                                    entered the <strong>SHORTENED</strong> URL
                                    below:
                                </p>
